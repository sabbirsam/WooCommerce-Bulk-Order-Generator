...
jQuery(document).ready(function ($) {
  ...
  $('#order-import-form').on('submit', function (e) {
    e.preventDefault();
    var csvFile = $('#order-import-form .file-upload-input')[0].files[0];
  ...
  $('#order-import-form .file-upload-input').on('change', function () {
    ...
    var preview = $('#order-import-form .file-upload-preview');
    if (file) {
      preview.html("<div class=\"upload-file-info\"><i class=\"upload-icon\">\uD83D\uDCC4</i> <span class=\"upload-text\">".concat(file.name, "</span></div>"));
    } else {
...
jQuery(document).ready(function ($) {
  ...
  $('#product-import-form').on('submit', function (e) {
    e.preventDefault();
    var csvFile = $('#product-import-form .file-upload-input')[0].files[0];
  ...
  $('#product-import-form .file-upload-input').on('change', function () {
    var file = this.files[0];
    var preview = $('#product-import-form .file-upload-preview');
    if (file) {
      preview.html("<div class=\"upload-file-info\"><i class=\"upload-icon\">\uD83D\uDCC4</i> <span class=\"upload-text\">".concat(file.name, "</span></div>"));
    } else {
      preview.html("<div class=\"upload-placeholder\"><i class=\"upload-icon\">\uD83D\uDCE4</i><span class=\"upload-text\">Drag & Drop or Click to Upload CSV</span></div>");
